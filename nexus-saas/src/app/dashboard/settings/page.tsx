    ...
    <div className="portal-page flex min-w-0 flex-col gap-5 overflow-x-hidden sm:gap-6">
      <div className="flex min-w-0 flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <div className="min-w-0">
          ...
          <p className="max-w-2xl break-words text-sm text-muted-foreground sm:text-base">Control the business setup that powers checkout, API orders, provider dispatch, and storefront access.</p>
        </div>
      </div>
      ...
      <div className="grid w-full max-w-6xl min-w-0 gap-5 sm:gap-6">
        ...
        <section className="grid gap-3">
          <div>
            <h2 className="break-words text-base font-semibold">Business Identity</h2>
            <p className="break-words text-sm text-muted-foreground">This name appears across the dashboard and storefront.</p>
          </div>
        ...
        <section className="grid gap-3">
          <div>
            <h2 className="break-words text-base font-semibold">Subscriber Payments</h2>
            <p className="break-words text-sm text-muted-foreground">Connect the subscriber&apos;s own Paystack account so storefront revenue does not pass through the SaaS owner.</p>
          </div>
          <PaymentSettingsCard />
        </section>
        <section className="grid gap-3">
          <div>
            <h2 className="flex min-w-0 items-center gap-2 text-base font-semibold">
              ...
              <span className="min-w-0 break-words">Fulfillment Routing</span>
            </h2>
        ...
        <section className="grid gap-3">
          <div>
            <h2 className="flex min-w-0 items-center gap-2 text-base font-semibold">
              ...
              <span className="min-w-0 break-words">External API Access</span>
            </h2>
            <p className="break-words text-sm text-muted-foreground">Create keys for trusted external websites that already collect payment and send orders for fulfillment.</p>
          </div>
