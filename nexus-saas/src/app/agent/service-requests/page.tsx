...
async function getAgentServiceRequests(status?: string, serviceId?: string) {
  ...
  const rows = requests.map((request): ServiceRequestRow => {
    ...
    return {
      ...
      sellerName: sellerId ? sellerMap.get(sellerId) || "Reseller" : "Your shop",
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div className="min-w-0">
          ...
          <p className="max-w-xl text-sm text-muted-foreground">
            View service forms submitted through your shop and reseller links.
          </p>
        </div>
        ...
        <CardContent className="space-y-3 p-4">
          <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">View each service separately across your shop and reseller links.</p>
            </div>
        ...
        <CardContent className="p-3 sm:p-6">
          {rows.length === 0 ? (
            <EmptyState
              ...
              action={hasFilters ? { label: "Show All", href: "/agent/service-requests" } : { label: "Share Shop", href: "/agent/storefronts" }}
            />
          ) : (
