    ...
    <div className="portal-page mx-auto w-full max-w-2xl space-y-6">
      <div className="space-y-6">
        ...
        <div className="space-y-1">
          <h1 className="text-2xl font-bold tracking-tight text-foreground md:text-3xl">Buy data</h1>
          <p className="text-sm text-muted-foreground">Create a single reseller purchase with guided pricing and confirmation.</p>
        </div>
            ...
            {!orderSuccess ? (
              <form className="space-y-5" onSubmit={handleSingleBuy}>
                ...
                <div className="space-y-2">
                  ...
                  <select
                    className="w-full rounded-md border border-input bg-background px-3 py-2.5 text-sm outline-none transition focus:ring-2 focus:ring-ring"
