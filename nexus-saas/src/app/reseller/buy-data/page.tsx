...
export default function ResellerBuyDataPage() {
    ...
    <div className="space-y-4 px-4 py-6 md:p-8 max-w-2xl mx-auto">
      <Tabs defaultValue="single" className="w-full">
        ...
        <TabsContent value="single" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-sm font-semibold">Buy Data</CardTitle>
            </CardHeader>
                    ...
                    <table className="min-w-[700px] w-full text-xs">
                      <thead className="bg-muted/40">
                        <tr>
                          ...
                          <th className="whitespace-nowrap border-b px-3 py-2 text-left font-medium text-muted-foreground">Bundle ID</th>
